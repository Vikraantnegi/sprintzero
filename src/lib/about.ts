 ...
 * Chosen operator name: Asuma / @AsumaCodes. No face, no invented metrics.
 */
export const aboutCopy = {
  ...
  intro: `SprintZero is run by Asuma — a solo operator in ${OPERATOR_LOCATION}. You talk to the person who scopes, builds, and ships — not a PM chain or a bench of freelancers.`,
